...
set rtp+=/home/westhues/.vim/bundle/Vundle.vim
...
" Send lines to an attached tmux pane
nnoremap <leader>l :VtrSendLinesToRunner<CR>
vnoremap <leader>l :VtrSendLinesToRunner<CR>

" The percent of the tmux window the runner pane will occupy
let g:VtrPercentage = 35
" Split pane to the right of the Vim pane
